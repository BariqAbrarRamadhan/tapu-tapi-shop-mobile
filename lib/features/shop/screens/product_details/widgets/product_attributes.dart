...
import 'package:tapu_tapi_shop/common/widgets/chips/choice_chip.dart';
        ...
        TRoundedContainer(
          ...
          child: Column(
            children: [
              ...
              const TProductTitleText(title: 'This is a variation product', smallSize: true, maxLines: 4),
            ],
          ),
        ),
